...
unsafe extern "C" {
    ...
    pub fn zx_clock_get_boot() -> zx_instant_boot_t;

    pub fn zx_clock_get_details(handle: zx_handle_t, options: u64, details: *mut u8)
    -> zx_status_t;

    pub fn zx_clock_get_details_mapped(
        clock_addr: *const u8,
        options: u64,
        details: *mut u8,
    ) -> zx_status_t;

    pub fn zx_clock_get_monotonic() -> zx_instant_mono_t;

    pub fn zx_clock_read(handle: zx_handle_t, now: *mut zx_time_t) -> zx_status_t;

    pub fn zx_clock_read_mapped(clock_addr: *const u8, now: *mut zx_time_t) -> zx_status_t;

    pub fn zx_clock_update(handle: zx_handle_t, options: u64, args: *const u8) -> zx_status_t;

    pub fn zx_counter_add(handle: zx_handle_t, value: i64) -> zx_status_t;

    pub fn zx_counter_create(options: u32, out: *mut zx_handle_t) -> zx_status_t;

    pub fn zx_counter_read(handle: zx_handle_t, value: *mut i64) -> zx_status_t;

    pub fn zx_counter_write(handle: zx_handle_t, value: i64) -> zx_status_t;
    ...
    pub fn zx_deadline_after(nanoseconds: zx_duration_mono_t) -> zx_instant_mono_t;
    ...
    pub fn zx_handle_check_valid(handle: zx_handle_t) -> zx_status_t;
    ...
    pub fn zx_iob_create_shared_region(
        options: u64,
        size: u64,
        out: *mut zx_handle_t,
    ) -> zx_status_t;

    pub fn zx_iob_writev(
        handle: zx_handle_t,
    ...
    pub fn zx_port_cancel_key(handle: zx_handle_t, options: u32, key: u64) -> zx_status_t;
    ...
    pub fn zx_restricted_bind_state(
        options: u32,
        out: *mut zx_handle_t,
        out_exception: *mut zx_exception_report_t,
    ) -> zx_status_t;
    ...
    pub fn zx_restricted_kick(thread: zx_handle_t, options: u32) -> zx_status_t;

    pub fn zx_restricted_unbind_state(options: u32) -> zx_status_t;
    ...
    pub fn zx_sampler_start(iobuffer: zx_handle_t) -> zx_status_t;

    pub fn zx_sampler_stop(iobuffer: zx_handle_t) -> zx_status_t;
    ...
    pub fn zx_syscall_test_rust_handle(handle: zx_handle_t, value: *mut u32) -> zx_status_t;
    ...
    pub fn zx_system_suspend_enter(
        ...
        options: zx_system_suspend_option_t,
        header: *mut zx_wake_source_report_header_t,
        entries: *mut zx_wake_source_report_entry_t,
        num_entries: u32,
        actual_entries: *mut u32,
    ) -> zx_status_t;

    pub fn zx_system_watch_memory_stall(
        resource: zx_handle_t,
        kind: u32,
        threshold: zx_duration_t,
        window: zx_duration_t,
        event: *mut zx_handle_t,
    ) -> zx_status_t;
    ...
    pub fn zx_thread_raise_exception(
        options: u32,
        r#type: u32,
    ...
    pub fn zx_thread_set_rseq(vmo: zx_handle_t, offset: u64, size: u64) -> zx_status_t;
    ...
    pub fn zx_ticks_get() -> zx_instant_mono_ticks_t;

    pub fn zx_ticks_get_boot() -> zx_instant_boot_ticks_t;
    ...
    pub fn zx_vmo_get_stream_size(handle: zx_handle_t, size: *mut u64) -> zx_status_t;
    ...
    pub fn zx_vmo_set_stream_size(handle: zx_handle_t, size: u64) -> zx_status_t;
