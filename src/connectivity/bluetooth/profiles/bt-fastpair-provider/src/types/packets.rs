...
pub enum KeyBasedPairingAction {
    ...
    // TODO(https://fxbug.dev/42182210): Add Device Action requests.
}
...
pub fn decrypt_key_based_pairing_request(
    ...
    match message_type {
        ...
        MessageType::DeviceAction => {
            ...
            // TODO(https://fxbug.dev/42182210): Support Device Action requests.
...
pub struct MessageStreamPacket {
    ...
    // TODO(https://fxbug.dev/42062580): This should be encapsulated in a wrapper type for all
