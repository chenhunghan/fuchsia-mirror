...
use crate::packets::{
    AvcCommandType, Equalizer, Error, PacketResult, PduId, PlayerApplicationSettings, ScanMode,
    ShuffleMode, VendorCommand, VendorDependentPdu,
};
...
impl TryFrom<GetCurrentPlayerApplicationSettingValueResponse> for PlayerApplicationSettings {
    ...
    fn try_from(
        ...
        while idx < src.num_values as usize {
            ...
            // TODO(https://fxbug.dev/42117316): If fetching the attribute_id fails, check to see if it's
