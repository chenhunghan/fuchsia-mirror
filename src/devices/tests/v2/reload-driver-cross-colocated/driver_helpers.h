...
#ifndef SRC_DEVICES_TESTS_V2_RELOAD_DRIVER_CROSS_COLOCATED_DRIVER_HELPERS_H_
#define SRC_DEVICES_TESTS_V2_RELOAD_DRIVER_CROSS_COLOCATED_DRIVER_HELPERS_H_
...
zx::result<fidl::ClientEnd<fuchsia_driver_framework::NodeController>> AddChild(
    ...
    std::string_view child_test_property, std::string_view driver_host_tag = "");
...
#endif  // SRC_DEVICES_TESTS_V2_RELOAD_DRIVER_CROSS_COLOCATED_DRIVER_HELPERS_H_
