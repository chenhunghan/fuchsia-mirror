...
static const std::vector<fpbus::Irq> bt_uart_irqs{
    {{
        .irq = fpbus::IrqSpec::WithIrq(T931_UART_A_IRQ),
...
zx_status_t Sherlock::BluetoothInit() {
  ...
  gpio_init_steps_.push_back(GpioFunction(T931_UART_A_TX, T931_UART_A_TX_FN));
  gpio_init_steps_.push_back(GpioFunction(T931_UART_A_RX, T931_UART_A_RX_FN));
  gpio_init_steps_.push_back(GpioFunction(T931_UART_A_CTS, T931_UART_A_CTS_FN));
  gpio_init_steps_.push_back(GpioFunction(T931_UART_A_RTS, T931_UART_A_RTS_FN));
