...
impl RepositoryConfig {
    pub fn repo_url(&self) -> &fuchsia_url::RepositoryUrl {
        &self.repo_url
    }
...
impl TryFrom<fidl::RepositoryConfig> for RepositoryConfig {
    ...
    fn try_from(other: fidl::RepositoryConfig) -> Result<Self, RepositoryParseError> {
        let repo_url: fuchsia_url::RepositoryUrl = other
            .repo_url
...
impl RepositoryConfigBuilder {
    pub fn new(repo_url: fuchsia_url::RepositoryUrl) -> Self {
    ...
    pub fn repo_url(mut self, repo_url: fuchsia_url::RepositoryUrl) -> Self {
...
impl RepositoryUrl {
    pub fn url(&self) -> &fuchsia_url::RepositoryUrl {
        &self.url
    }
}

impl From<fuchsia_url::RepositoryUrl> for RepositoryUrl {
    fn from(url: fuchsia_url::RepositoryUrl) -> Self {
        Self { url }
    }
}
...
mod tests {
    ...
    fn test_repository_key_from_fidl_with_bad_type() {
        let as_fidl = fidl::RepositoryKeyConfig::unknown_variant_for_testing();
        assert_matches!(
            RepositoryKey::try_from(as_fidl),
    ...
    fn test_repository_config_builder() {
        let repo_url = fuchsia_url::RepositoryUrl::parse("fuchsia-pkg://fuchsia.com").unwrap();
    ...
    fn test_repository_config_into_fidl() {
        let config = RepositoryConfig {
            repo_url: "fuchsia-pkg://fuchsia.com".parse().unwrap(),
            root_version: 2,
            root_threshold: 2,
        ...
        assert_eq!(
            ...
            fidl::RepositoryConfig {
                repo_url: Some("fuchsia-pkg://fuchsia.com".parse().unwrap()),
                root_version: Some(2),
    ...
    fn test_repository_url_from_fidl_with_bad_url() {
        ...
        assert_matches!(
            RepositoryUrl::try_from(&as_fidl),
            Err(RepositoryUrlParseError::InvalidRepoUrl(fuchsia_url::ParseError::InvalidScheme))
        );
    }
