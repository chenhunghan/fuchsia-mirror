...
#ifndef SRC_LIB_ZBITL_INCLUDE_LIB_ZBITL_ERROR_STDIO_H_
#define SRC_LIB_ZBITL_INCLUDE_LIB_ZBITL_ERROR_STDIO_H_
...
#endif  // SRC_LIB_ZBITL_INCLUDE_LIB_ZBITL_ERROR_STDIO_H_
