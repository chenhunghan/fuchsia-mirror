...
pub const ZBI_KERNEL_DRIVER_ARM_PSCI_CPU_SUSPEND: zbi_kernel_driver_t = 1396921168;
...
pub const ZBI_KERNEL_DRIVER_ARM_GENERIC_TIMER_MMIO: zbi_kernel_driver_t = 1296913473;
...
pub const ZBI_KERNEL_DRIVER_AMLOGIC_RNG: zbi_kernel_driver_t = 1212960082;
...
pub const ZBI_KERNEL_DRIVER_MOONFLOWER_POWER: zbi_kernel_driver_t = 1296975440;
pub const ZBI_KERNEL_DRIVER_IRIS_POWER: zbi_kernel_driver_t = 1230132048;
...
pub const ZBI_KERNEL_DRIVER_EXYNOS_USI_UART: zbi_kernel_driver_t = 1163417941;
pub const ZBI_KERNEL_DRIVER_QCOM_RNG: zbi_kernel_driver_t = 1196315217;
pub const ZBI_KERNEL_DRIVER_ARM_SMMU: zbi_kernel_driver_t = 1431129425;
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq, FromBytes, IntoBytes, Immutable, KnownLayout)]
...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq, FromBytes, IntoBytes, Immutable, KnownLayout)]
pub struct zbi_dcfg_arm_generic_timer_mmio_frame_t {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of zbi_dcfg_arm_generic_timer_mmio_frame_t"]
        [::core::mem::size_of::<zbi_dcfg_arm_generic_timer_mmio_frame_t>() - 32usize];
    ["Alignment of zbi_dcfg_arm_generic_timer_mmio_frame_t"]
        [::core::mem::align_of::<zbi_dcfg_arm_generic_timer_mmio_frame_t>() - 8usize];
    ["Offset of field: zbi_dcfg_arm_generic_timer_mmio_frame_t::mmio_phys_el1"]
        [::core::mem::offset_of!(zbi_dcfg_arm_generic_timer_mmio_frame_t, mmio_phys_el1) - 0usize];
    ["Offset of field: zbi_dcfg_arm_generic_timer_mmio_frame_t::mmio_phys_el0"]
        [::core::mem::offset_of!(zbi_dcfg_arm_generic_timer_mmio_frame_t, mmio_phys_el0) - 8usize];
    ["Offset of field: zbi_dcfg_arm_generic_timer_mmio_frame_t::irq_phys"]
        [::core::mem::offset_of!(zbi_dcfg_arm_generic_timer_mmio_frame_t, irq_phys) - 16usize];
    ["Offset of field: zbi_dcfg_arm_generic_timer_mmio_frame_t::irq_phys_flags"][::core::mem::offset_of!(
        zbi_dcfg_arm_generic_timer_mmio_frame_t,
        irq_phys_flags
    ) - 20usize];
    ["Offset of field: zbi_dcfg_arm_generic_timer_mmio_frame_t::irq_virt"]
        [::core::mem::offset_of!(zbi_dcfg_arm_generic_timer_mmio_frame_t, irq_virt) - 24usize];
    ["Offset of field: zbi_dcfg_arm_generic_timer_mmio_frame_t::irq_virt_flags"][::core::mem::offset_of!(
        zbi_dcfg_arm_generic_timer_mmio_frame_t,
        irq_virt_flags
    ) - 28usize];
};
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq, FromBytes, IntoBytes, Immutable, KnownLayout)]
pub struct zbi_dcfg_arm_generic_timer_mmio_driver_t {
    pub mmio_phys: u64,
    pub frequency: u32,
    pub active_frames_mask: u8,
    pub reserved0: [u8; 3usize],
    pub frames: [zbi_dcfg_arm_generic_timer_mmio_frame_t; 8usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of zbi_dcfg_arm_generic_timer_mmio_driver_t"]
        [::core::mem::size_of::<zbi_dcfg_arm_generic_timer_mmio_driver_t>() - 272usize];
    ["Alignment of zbi_dcfg_arm_generic_timer_mmio_driver_t"]
        [::core::mem::align_of::<zbi_dcfg_arm_generic_timer_mmio_driver_t>() - 8usize];
    ["Offset of field: zbi_dcfg_arm_generic_timer_mmio_driver_t::mmio_phys"]
        [::core::mem::offset_of!(zbi_dcfg_arm_generic_timer_mmio_driver_t, mmio_phys) - 0usize];
    ["Offset of field: zbi_dcfg_arm_generic_timer_mmio_driver_t::frequency"]
        [::core::mem::offset_of!(zbi_dcfg_arm_generic_timer_mmio_driver_t, frequency) - 8usize];
    ["Offset of field: zbi_dcfg_arm_generic_timer_mmio_driver_t::active_frames_mask"][::core::mem::offset_of!(
        zbi_dcfg_arm_generic_timer_mmio_driver_t,
        active_frames_mask
    ) - 12usize];
    ["Offset of field: zbi_dcfg_arm_generic_timer_mmio_driver_t::reserved0"]
        [::core::mem::offset_of!(zbi_dcfg_arm_generic_timer_mmio_driver_t, reserved0) - 13usize];
    ["Offset of field: zbi_dcfg_arm_generic_timer_mmio_driver_t::frames"]
        [::core::mem::offset_of!(zbi_dcfg_arm_generic_timer_mmio_driver_t, frames) - 16usize];
};
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq, FromBytes, IntoBytes, Immutable, KnownLayout)]
...
const _: () = {
    ...
    ["Offset of field: zbi_dcfg_riscv_plic_driver_t::size_bytes"]
        [::core::mem::offset_of!(zbi_dcfg_riscv_plic_driver_t, size_bytes) - 8usize];
    ["Offset of field: zbi_dcfg_riscv_plic_driver_t::num_irqs"]
        [::core::mem::offset_of!(zbi_dcfg_riscv_plic_driver_t, num_irqs) - 12usize];
};
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq, FromBytes, IntoBytes, Immutable, KnownLayout)]
...
pub type zbi_arm_psci_cpu_suspend_state_flags_t = u32;
pub const ZBI_ARM_PSCI_CPU_SUSPEND_STATE_FLAGS_LOCAL_TIMER_STOPS:
    zbi_arm_psci_cpu_suspend_state_flags_t = 1;
pub const ZBI_ARM_PSCI_CPU_SUSPEND_STATE_FLAGS_TARGETS_POWER_DOMAIN:
    zbi_arm_psci_cpu_suspend_state_flags_t = 2;
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq, FromBytes, IntoBytes, Immutable, KnownLayout)]
pub struct zbi_dcfg_arm_psci_cpu_suspend_state_t {
    pub id: u32,
    pub power_state: u32,
    pub flags: zbi_arm_psci_cpu_suspend_state_flags_t,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of zbi_dcfg_arm_psci_cpu_suspend_state_t"]
        [::core::mem::size_of::<zbi_dcfg_arm_psci_cpu_suspend_state_t>() - 24usize];
    ["Alignment of zbi_dcfg_arm_psci_cpu_suspend_state_t"]
        [::core::mem::align_of::<zbi_dcfg_arm_psci_cpu_suspend_state_t>() - 4usize];
    ["Offset of field: zbi_dcfg_arm_psci_cpu_suspend_state_t::id"]
        [::core::mem::offset_of!(zbi_dcfg_arm_psci_cpu_suspend_state_t, id) - 0usize];
    ["Offset of field: zbi_dcfg_arm_psci_cpu_suspend_state_t::power_state"]
        [::core::mem::offset_of!(zbi_dcfg_arm_psci_cpu_suspend_state_t, power_state) - 4usize];
    ["Offset of field: zbi_dcfg_arm_psci_cpu_suspend_state_t::flags"]
        [::core::mem::offset_of!(zbi_dcfg_arm_psci_cpu_suspend_state_t, flags) - 8usize];
    ["Offset of field: zbi_dcfg_arm_psci_cpu_suspend_state_t::entry_latency_us"][::core::mem::offset_of!(
        zbi_dcfg_arm_psci_cpu_suspend_state_t,
        entry_latency_us
    ) - 12usize];
    ["Offset of field: zbi_dcfg_arm_psci_cpu_suspend_state_t::exit_latency_us"]
        [::core::mem::offset_of!(zbi_dcfg_arm_psci_cpu_suspend_state_t, exit_latency_us) - 16usize];
    ["Offset of field: zbi_dcfg_arm_psci_cpu_suspend_state_t::min_residency_us"][::core::mem::offset_of!(
        zbi_dcfg_arm_psci_cpu_suspend_state_t,
        min_residency_us
    ) - 20usize];
};
pub type zbi_qcom_rng_flags_t = u32;
pub const ZBI_QCOM_RNG_FLAGS_ENABLED: zbi_qcom_rng_flags_t = 1;
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq, FromBytes, IntoBytes, Immutable, KnownLayout)]
pub struct zbi_dcfg_qcom_rng_t {
    pub mmio_phys: u64,
    pub flags: zbi_qcom_rng_flags_t,
    pub reserved: [u8; 4usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of zbi_dcfg_qcom_rng_t"][::core::mem::size_of::<zbi_dcfg_qcom_rng_t>() - 16usize];
    ["Alignment of zbi_dcfg_qcom_rng_t"][::core::mem::align_of::<zbi_dcfg_qcom_rng_t>() - 8usize];
    ["Offset of field: zbi_dcfg_qcom_rng_t::mmio_phys"]
        [::core::mem::offset_of!(zbi_dcfg_qcom_rng_t, mmio_phys) - 0usize];
    ["Offset of field: zbi_dcfg_qcom_rng_t::flags"]
        [::core::mem::offset_of!(zbi_dcfg_qcom_rng_t, flags) - 8usize];
    ["Offset of field: zbi_dcfg_qcom_rng_t::reserved"]
        [::core::mem::offset_of!(zbi_dcfg_qcom_rng_t, reserved) - 12usize];
};
pub const ZBI_KERNEL_DRIVER_SMMU_MAX_IRQS: u32 = 128;
pub const ZBI_KERNEL_DRIVER_SMMU_MAX_HANDOFF_SMRS: u32 = 16;
pub type zbi_arm_smmu_irq_flags_t = u32;
pub const ZBI_ARM_SMMU_IRQ_FLAGS_RISING_EDGE: zbi_arm_smmu_irq_flags_t = 1;
pub const ZBI_ARM_SMMU_IRQ_FLAGS_FALLING_EDGE: zbi_arm_smmu_irq_flags_t = 2;
pub const ZBI_ARM_SMMU_IRQ_FLAGS_ACTIVE_HIGH: zbi_arm_smmu_irq_flags_t = 4;
pub const ZBI_ARM_SMMU_IRQ_FLAGS_ACTIVE_LOW: zbi_arm_smmu_irq_flags_t = 8;
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq, FromBytes, IntoBytes, Immutable, KnownLayout)]
pub struct zbi_dcfg_arm_smmu_irq_t {
    pub num: u32,
    pub flags: zbi_arm_smmu_irq_flags_t,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of zbi_dcfg_arm_smmu_irq_t"][::core::mem::size_of::<zbi_dcfg_arm_smmu_irq_t>() - 8usize];
    ["Alignment of zbi_dcfg_arm_smmu_irq_t"]
        [::core::mem::align_of::<zbi_dcfg_arm_smmu_irq_t>() - 4usize];
    ["Offset of field: zbi_dcfg_arm_smmu_irq_t::num"]
        [::core::mem::offset_of!(zbi_dcfg_arm_smmu_irq_t, num) - 0usize];
    ["Offset of field: zbi_dcfg_arm_smmu_irq_t::flags"]
        [::core::mem::offset_of!(zbi_dcfg_arm_smmu_irq_t, flags) - 4usize];
};
...
pub type zbi_secure_entropy_t = u32;
pub const ZBI_SECURE_ENTROPY_GENERAL: zbi_secure_entropy_t = 0;
pub const ZBI_SECURE_ENTROPY_EARLY_BOOT: zbi_secure_entropy_t = 1;
...
pub const ZBI_TYPE_LINUX_BOOTCONFIG: zbi_type_t = 1195787074;
...
pub const ZBI_FLAGS_STORAGE_COMPRESSED: zbi_flags_t = 1;
