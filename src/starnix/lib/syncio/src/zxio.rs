...
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, Immutable, IntoBytes, FromBytes, KnownLayout)]
pub struct timespec {
    pub tv_sec: time_t,
...
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, Immutable, IntoBytes, KnownLayout, TryFromBytes)]
...
#[repr(C)]
#[derive(Clone, Copy, Immutable, IntoBytes, FromBytes, KnownLayout)]
