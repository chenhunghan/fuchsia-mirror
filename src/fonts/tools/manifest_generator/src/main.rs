...
#[derive(Debug, Parser)]
#[command(name = "Font Manifest Generator")]
struct Args {
    #[arg(
        long = "empty",
        conflicts_with_all = &["local_fonts", "font_pkgs", "font_catalog", "product_config", "font_dir", "fake_code_points"],
    ...
    #[arg(long = "pretty-print", help = "If true, indents output JSON.")]
    pretty_print: bool,
...
fn main() -> Result<(), Error> {
    ...
    let manifest = if args.empty {
        ...
        let font_sets = FontSets::load_from_local_paths(args.local_fonts.unwrap())?;
