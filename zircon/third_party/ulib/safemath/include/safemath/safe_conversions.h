...
#include <safemath/safe_conversions_impl.h>  // IWYU pragma: export

#if defined(__ARMEL__)
#include <safemath/safe_conversions_arm_impl.h>  // IWYU pragma: export
...
#if !SAFEMATH_HAS_OPTIMIZED_SAFE_CONVERSIONS
...
#endif  // SAFEMATH_HAS_OPTIMIZED_SAFE_CONVERSIONS
#undef SAFEMATH_HAS_OPTIMIZED_SAFE_CONVERSIONS
...
SAFEMATH_NUMERIC_COMPARISON_OPERATORS(Strict, IsLess, <)
SAFEMATH_NUMERIC_COMPARISON_OPERATORS(Strict, IsLessOrEqual, <=)
SAFEMATH_NUMERIC_COMPARISON_OPERATORS(Strict, IsGreater, >)
SAFEMATH_NUMERIC_COMPARISON_OPERATORS(Strict, IsGreaterOrEqual, >=)
SAFEMATH_NUMERIC_COMPARISON_OPERATORS(Strict, IsEqual, ==)
SAFEMATH_NUMERIC_COMPARISON_OPERATORS(Strict, IsNotEqual, !=)
...
#endif  // SAFEMATH_SAFE_CONVERSIONS_H_
